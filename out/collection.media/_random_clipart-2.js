// To use, place the following lines into a card template:
/*
<span id="query-image" style="display: none;">{{Front}}</span>
<div id="google-image"></div>
<script type="text/javascript" src="_random_clipart-2.js"></script>
*/

// Changelog
// 2 - fixed errors in ChromeOS
